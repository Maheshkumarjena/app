      ...
      <nav className=" navbar bg-white w-[100vw] border-gray-200 py-2.5 bg-gray-200 color-gray-900">
        <div className="flex  flex-wrap items-center justify-between max-w-[1500px] px-[1px] md:px-4 lg:px-6 mx-auto">
          <Link href="#" className=" z-50 flex items-center">
            ...
            <span
              z-50
              className="self-center hidden xsm:flex text-xl font-semibold whitespace-nowrap text-gray-900"
            >
              AlumNexus
            </span>
          </Link>
          <div className="flex items-center lg:order-2">
            ...
            <button
              ...
              className="mr-4 p-2 text-gray-500"
            >
              {theme === "light"
                ? "Switch to Dark Mode"
          ...
          >
            ...
            >
              <li>
                <Link
                  href="/"
                  className="block py-2 pl-3 pr-4 text-gray-900 border-b border-gray-100 hover:bg-[#F8F8F8] lg:hover:bg-transparent lg:border-0 lg:hover:text-purple-700 lg:p-0"
                >
                  Home
                </Link>
              </li>
