    ...
    >
      <div className="flex flex-wrap items-center justify-between max-w-[1500px] px-[1px] md:px-4 lg:px-6 mx-auto">
        ...
        <div className="flex items-center lg:order-2">
          ...
          <Link
            href="Login"
            className={`black_btn rounded-[20px] text-white ${
              theme === "light" ? " text-white" : "bg-blue-700 text-white"
            } hover:${theme === "light" ? "bg-gray-900" : "bg-blue-800"} focus:ring-2 focus:ring-blue-300 font-medium rounded-lg text-sm px-4 lg:px-4 py-2 lg:py-1.5 sm:mr-2 lg:mr-0 focus:outline-none`}
          >
            <p>
              <FontAwesomeIcon
                icon={faUser}
            ...
            <li>
              <Link
                ...
                className={`block py-2 pl-3 pr-4 ${
                  theme === "light" ? "text-gray-900 border-b border-gray-100" : "text-white border-gray-800"
                } hover:bg-[#F8F8F8] lg:hover:bg-transparent lg:border-0 lg:hover:text-gray-300 lg:p-0`}
              >
                Home
              </Link>
            </li>
