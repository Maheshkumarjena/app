...
const AlumniCard = ({ name, title, company, image }) => (
    <div  className="w-[40vw]  xsm:w-[30vw]   md:w-1/5 lg:w-1/5   min-w-[120px] md:min-w-[150px] bg-white rounded-lg shadow-lg text-center mt-4 max-h-[250px] md:max-h-[280px]  lg:max-h-[450px] ">
